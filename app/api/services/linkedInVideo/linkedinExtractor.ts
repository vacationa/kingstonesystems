...
import type { ExtractedVideo } from "./baseExtractor";
import LinkedInParser from "./linkedinParser";
import Request from "./linkedInRequest";
...
class LinkedInExtractor extends BaseExtractor {
  ...
  urlPattern: RegExp =
    // @ts-ignore
    /^https?:\/\/(?:www\.)?linkedin\.com\/(?:posts|feed\/update)\/[^\/]+?(?<id>\d{10,})/;
  id!: string;
  urlSamples = [
    "https://www.linkedin.com/posts/mrdavidorok_africa-nocode-mobileappdevelopment-activity-7046318506119688192-kGWZ",
    "https://www.linkedin.com/posts/future-electronics%27%E2%80%8B-ftm-board-club_wireless-just-got-better-again-activity-7040993763980144640-To5Y",
    "https://www.linkedin.com/posts/tanvir1407_frontend-development-ugcPost-7044714431708098561-fZ5W",
    "https://www.linkedin.com/feed/update/urn:li:activity:7045067314035052544",
  ];
  ...
  async extractVideo(): Promise<ExtractedVideo> {
    ...
    const title =
      _.get(jsonld, "title") ||
      parser.getOgDescription() ||
      parser.getMetaContent("description") ||
      "";
    ...
    const thumbnail =
      _.get(videoData, "thumbnail") || parser.getOgThumbnail() || _.get(jsonld, "thumbnail");
